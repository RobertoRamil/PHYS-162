...
# Double Gaussian Fit
#initial_guesses = [max(counts), bin_centers[np.argmax(counts)], 1, max(counts) / 2, bin_centers[np.argmax(counts)] + 1, 1]
initial_guesses = np.arange(6)
